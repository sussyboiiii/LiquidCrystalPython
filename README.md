...
The purpose of this project was to test the display logic of an e-bike display project ([Here](https://github.com/sussyboiiii/BESC_LCD_DISPLAY)) without needing an Arduino or LCD. As there wasn't anyway to do this without an arduino before, I made this repo.
